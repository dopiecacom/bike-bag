<div class="container mx-auto px-4">
  <div class="max-w-6xl mx-auto my-16">
    <p class="text-3xl font-normal mb-8 leading-9">
    ...
    <ul class="max-w-4xl mx-auto space-y-0.5 text-xl font-normal leading-relaxed list-disc list-inside mb-12">
    ...
    <p class="text-3xl font-normal leading-9">
