...
<footer class="bg-black text-white">
  <div class="max-w-4xl 2xl:container mx-auto px-4 py-12">
    <div class="flex flex-col lg:flex-row lg:justify-between gap-12 mb-8">
      <div>
        ...
        <div class="mt-12 space-y-2 text-xl font-normal">
      ...
      <div class="lg:mr-0">
        ...
        <ul class="space-y-2 text-xl font-normal">
          ...
          ?>
          <li><a href="<?= esc_url($offer_url); ?>" class="hover:font-bold hover:underline <?= $is_offer ? 'font-bold underline' : ''; ?>">Co oferujemy</a></li>
          <li><a href="<?= esc_url($pricing_url); ?>" class="hover:font-bold hover:underline <?= $is_pricing ? 'font-bold underline' : ''; ?>">Cennik</a></li>
  ...
  <div class="bg-bike-purple py-2">
    <div class="container mx-auto px-4">
      <p class="text-sm font-medium text-[#ebebeb] text-center">Designed by Emsit 2025</p>
    </div>
  </div>
</footer>
